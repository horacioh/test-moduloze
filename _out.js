...
proto.mintter.v2.UpdateDraftRequest.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(1, f, proto.mintter.v2.Document.serializeBinaryToWriter);
  }
...
proto.mintter.v2.UpdateDraftRequest.prototype.getDocument = function () {
  return (
    /** @type{?proto.mintter.v2.Document} */
...
proto.mintter.v2.UpdateDraftRequest.prototype.getBlocksMap = function (opt_noLazyCreate) {
  return (
    /** @type {!jspb.Map<string,!proto.mintter.v2.Block>} */
    jspb.Message.getMapField(this, 2, opt_noLazyCreate, proto.mintter.v2.Block)
  );
};
/**
...
proto.mintter.v2.ListDocumentsRequest.deserializeBinaryFromReader = function (msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
      ...
      case 3:
        var value =
        /** @type {!proto.mintter.v2.PublishingState} */
        reader.readEnum();
...
if (jspb.Message.GENERATE_TO_OBJECT) {
  ...
  proto.mintter.v2.ListDocumentsResponse.toObject = function (includeInstance, msg) {
    var f,
        obj = {
      documentsList: jspb.Message.toObjectList(msg.getDocumentsList(), proto.mintter.v2.Document.toObject, includeInstance),
...
proto.mintter.v2.ListDocumentsResponse.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(1, f, proto.mintter.v2.Document.serializeBinaryToWriter);
  }
...
proto.mintter.v2.ListDocumentsResponse.prototype.getDocumentsList = function () {
  return (
    /** @type{!Array<!proto.mintter.v2.Document>} */
...
proto.mintter.v2.Document.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(8, f, proto.mintter.v2.BlockRefList.serializeBinaryToWriter);
  }
...
proto.mintter.v2.Document.prototype.getBlockRefList = function () {
  return (
    /** @type{?proto.mintter.v2.BlockRefList} */
...
if (jspb.Message.GENERATE_TO_OBJECT) {
  ...
  proto.mintter.v2.BlockRefList.toObject = function (includeInstance, msg) {
    var f,
      ...
      refsList: jspb.Message.toObjectList(msg.getRefsList(), proto.mintter.v2.BlockRef.toObject, includeInstance)
    };
...
proto.mintter.v2.BlockRefList.deserializeBinaryFromReader = function (msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        var value =
        /** @type {!proto.mintter.v2.BlockRefList.Style} */
        reader.readEnum();
        msg.setStyle(value);
        break;
...
proto.mintter.v2.BlockRefList.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(2, f, proto.mintter.v2.BlockRef.serializeBinaryToWriter);
  }
};
/**
 * @enum {number}
...
proto.mintter.v2.BlockRefList.prototype.getRefsList = function () {
  return (
    /** @type{!Array<!proto.mintter.v2.BlockRef>} */
...
proto.mintter.v2.BlockRef.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(2, f, proto.mintter.v2.BlockRefList.serializeBinaryToWriter);
  }
};
/**
...
proto.mintter.v2.Block.prototype.getContentCase = function () {
  return (
    /** @type {proto.mintter.v2.Block.ContentCase} */
    jspb.Message.computeOneofCase(this, proto.mintter.v2.Block.oneofGroups_[0])
  );
};
...
proto.mintter.v2.Block.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(3, f, proto.mintter.v2.Paragraph.serializeBinaryToWriter);
  }

  f = message.getImage();

  if (f != null) {
    writer.writeMessage(4, f, proto.mintter.v2.Image.serializeBinaryToWriter);
  }
};
/**
 * optional string id = 1;
...
proto.mintter.v2.Block.prototype.getParagraph = function () {
  return (
    /** @type{?proto.mintter.v2.Paragraph} */
...
if (jspb.Message.GENERATE_TO_OBJECT) {
  ...
  proto.mintter.v2.Paragraph.toObject = function (includeInstance, msg) {
    var f,
        obj = {
      inlineElementsList: jspb.Message.toObjectList(msg.getInlineElementsList(), proto.mintter.v2.InlineElement.toObject, includeInstance)
    };
...
proto.mintter.v2.Paragraph.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(1, f, proto.mintter.v2.InlineElement.serializeBinaryToWriter);
  }
};
/**
...
proto.mintter.v2.Paragraph.prototype.getInlineElementsList = function () {
  return (
    /** @type{!Array<!proto.mintter.v2.InlineElement>} */
...
proto.mintter.v2.InlineElement.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(2, f, proto.mintter.v2.TextStyle.serializeBinaryToWriter);
  }
};
/**
...
proto.mintter.v2.InlineElement.prototype.getTextStyle = function () {
  return (
    /** @type{?proto.mintter.v2.TextStyle} */
...
let _exp = {};
goog.object.extend(_exp, proto.mintter.v2);
export default _exp;